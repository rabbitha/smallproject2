...
//----------------------------------------------------------------------------------------------------------------------------------//
    ...
    public void userCreateAccount() {
        ...
        driver.findElement(By.id("email")).sendKeys("traaa@testing.com");
    ...
    public void userConfirmOrderHotelRoom() {
        //verify type kamar order
            ...
            String actual_room1_order = driver.findElement(By.xpath("//*[@id=\"collapse-shopping-cart\"]/div/div[2]/div[2]/div[2]/div[1]/div[2]/p[1]/a[1]")).getText();
            ...
            String actual_room2_order = driver.findElement(By.xpath("//*[@id=\"collapse-shopping-cart\"]/div/div[2]/div[1]/div[2]/div[1]/div[2]/p[1]/a[1]")).getText();
