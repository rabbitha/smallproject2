...
public class bookingStepDef {
    ...
    public void userChooseHotel() {
        ...
        if (driver.getPageSource().contains("General Room")){
            driver.getPageSource().contains("Delux Room");
            driver.getPageSource().contains("Executive Room");
            driver.getPageSource().contains("Luxury Room");
    ...
    public void userConfirmOrder() throws InterruptedException{
        ...
        driver.findElement(By.id("cgv")).click();
            Thread.sleep(3000);
//        WebDriverWait wait = new WebDriverWait (driver, Duration.ofSeconds(10));
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("bankwire")));
